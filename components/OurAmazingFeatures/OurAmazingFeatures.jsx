...
const OurAmazingFeatures = () => {
  ...
  return (
    <section className="relative py-10 px-7 overflow-hidden bg-gradient-to-br from-blue-900 via-indigo-900 to-blue-950">
      ...
      <div className="container bg-gradient-to-br from-blue-900 via-indigo-900 to-blue-950 relative px-8 py-16 md:py-24">
