...
// Investment Logic 
export async function investAmount({ userID, planName, assetName, amount, profit, walletID }) {
  await connectToDB();
  ...
  try {
    ...
    return { success: true, message: "Investment created successfully", investment };
  } catch (error) {
